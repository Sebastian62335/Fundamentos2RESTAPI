...
public class Fundamentos2 implements CommandLineRunner {
    ...
    public Fundamentos2(MyBean myBean, @Qualifier("cualquierNombre") MyComponent myComponent, UserProperties userProperties, UserRepository userRepository, UserService userService, PostRepository postRepository) {
        this.myBean = myBean;
    ...
    public static void main(String[] args) {
        SpringApplication.run(Fundamentos2.class, args);
    }
